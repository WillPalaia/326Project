...
export class AddPersonalTrailComponent extends BaseComponent {
  constructor() {
    super();
    this.loadCSS("PersonalTrailComponent");
  ...
  render() {
    ...
    container.classList.add("add-personal-trail-container");
    ...
    headerTitle.textContent = "Add Your Personal Trail";
